...
struct PastCancelContentView: View {
    ...
    let applicationList: [ApplicationItem] = {
        ...
        for i in 1...15 {
            let item = ApplicationItem(iconImage: "", title: "予約中", reservationNumber: "予約番号ST-000000000", country: "ハワイ・ホノルル", date: "2021年12月23日 10:00", description: "オプショナルツアータイトルを記載オプシ ョナルツアータイトルタイトルを記載", color: .blue)
            array.append(item)
        }
        return array
    }()
...
struct PastCancelContentView_Previews: PreviewProvider {
